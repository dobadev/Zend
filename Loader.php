...
class Zend_Loader
{
    ...
    public static function loadClass($class, $dirs = null)
    {
        ...
        if (!empty($dirs)) {
            ...
            if ((include $file) === false && substr($file, 0, 4) == 'Doba') {
				//$msg = 'Invalid file requested. Requested ' . $file . "\n\n" . 'Backtrace: ' . Lib_Utility_Functions::simple_backtrace() . "\n\n" . 'Server Vars: ' . var_export($_SERVER, true);
                //error_log($msg, 1, 'lsteelman@doba.com');
            }
        }
